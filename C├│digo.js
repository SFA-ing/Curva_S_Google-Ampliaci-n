...
function doGet() {
  return HtmlService.createHtmlOutputFromFile("Index")
    .setTitle(typeof PROJECT_NAME !== "undefined" ? PROJECT_NAME : "Reporte Avance Físico")
    .setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
}

// ============================================================
//  EXPORTACIÓN A HOJA CACHE
//  CACHE_SHEET_ID y DASHBOARD_KEY viven en Config.js
// ============================================================
...
function getDashboardData(cutMondayISO) {
  ...
  return {
  meta: {
    projectName    : (typeof PROJECT_NAME !== "undefined") ? PROJECT_NAME : "Reporte Avance Físico",
